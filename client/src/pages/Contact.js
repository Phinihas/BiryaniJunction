...
const contactInfo = [
    ...
    },
    {
        icon: <FaPhone />,
        title: 'Phone',
        content: '+91 7995802047'
    },
    {
        icon: <FaEnvelope />,
        title: 'Email',
        content: 'phinihasgandi@gmail.com'
    },
    {
        icon: <FaClock />,
        title: 'Hours',
...
const socialLinks = [
    {
        ...
        url: 'https://www.instagram.com/phinihasgandi/'
    },
    {
        icon: <FaTwitter className="text-orange-500" />,
        url: 'https://x.com/GandiPhinihas'
    }
];
